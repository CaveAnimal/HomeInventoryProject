...
This folder holds larger ideas that may become separate projects or major workstreams for the Home Inventory application.

## Notes

- `container-hierarchy/` - Expand from boxes to nested containers such as rooms, drawers, shelves, tool chests, and garages.
